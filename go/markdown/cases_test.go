...
var testCases = []struct {
	...
	{
		description: "parsing double italics",
		input:       "_This will be italic_ and _so will this_",
		expected:    "<p><em>This will be italic</em> and <em>so will this</em></p>",
	},
	{
	...
	{
		description: "parsing double bold text",
		input:       "__This will be bold__ and __so will this__",
		expected:    "<p><strong>This will be bold</strong> and <strong>so will this</strong></p>",
	},
	{
